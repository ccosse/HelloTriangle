//working7.cpp ~ https://vulkan-tutorial.com/Texture_mapping/Images
...
private:
    ...
    bool isDeviceSuitable(VkPhysicalDevice device) {
        ...
        vkGetPhysicalDeviceFeatures(device, &supportedFeatures);//check samplerAnisotropy supported for sampler
    ...
    void createLogicalDevice() {
        ...
        deviceFeatures.samplerAnisotropy = VK_TRUE;//need to request it to use it @crateTextureSampler()
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("shaders/vert7.spv");
        auto fragShaderCode = readFile("shaders/frag7.spv");
    ...
    void createTextureSampler() {
        ...
        VkPhysicalDeviceProperties properties{};//get maxAnisotropy suported by device by querying device
        vkGetPhysicalDeviceProperties(physicalDevice, &properties);
        samplerInfo.maxAnisotropy = properties.limits.maxSamplerAnisotropy;
        samplerInfo.borderColor = VK_BORDER_COLOR_INT_OPAQUE_BLACK;
        samplerInfo.unnormalizedCoordinates = VK_FALSE;
        samplerInfo.compareEnable = VK_FALSE;//FALSE -> normalized range so good for imgs of arb resolution
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        //flip the y-coordinate (Vulkan is right-handed RCCS?)
        ubo.proj[1][1] *= -1;

        memcpy(uniformBuffersMapped[currentImage], &ubo, sizeof(ubo));//push constants would be more efficient here
    }//14d
