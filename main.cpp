...
private:
    ...
    void createVertexBuffer() {
        ...
        bufferInfo.sharingMode = VK_SHARING_MODE_EXCLUSIVE;// used exclusively by graphics buffer here
        ...
        vkBindBufferMemory(device, vertexBuffer, vertexBufferMemory, 0);//0 ~mem offset = 0 since specifically for this vertex buffer
        //if non-zero then must be divisible by memRequirements.alignment
